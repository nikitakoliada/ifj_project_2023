...
#define SYNTAX_OK 0
#define TOKEN_OK 0
#define LEX_ERROR 1 // structure of current lexem error
...
#define SEM_ERROR_TYPE_DERIV 8 // type of variable or parameter isn't specified and can't be derivated from used expression
#define SEM_ERROR_OTHER 9 // other semantical errors
#define INTERAL_ERROR 99 // internal error of compiler not caused by input program (memory allocation, etc.)
